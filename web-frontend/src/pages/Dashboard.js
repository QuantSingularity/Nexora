...
const Dashboard = () => {
  ...
  // Build chart datasets only when data is available
  ...
  return (
    <Box>
      ...
      {/* Content */}
      {!loading && !error && dashboardData && chartData && (
        <>
          {/* Stat Cards */}
          <Grid container spacing={3} sx={{ mb: 4 }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <StatCard
                ...
                subtitle={`${(
                  (dashboardData.stats.highRiskPatients /
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Card>
                <CardHeader
                  title="Model Performance Metrics (AUC)"
                  action={
                    <IconButton aria-label="options">
                      <MoreVertIcon />
                    </IconButton>
                      ...
                      options={{
                        ...
                        scales: {
                          y: {
                            beginAtZero: true,
                            max: 1,
                            title: { display: true, text: "AUC Score" },
                          },
                        },
                      }}
                    />
