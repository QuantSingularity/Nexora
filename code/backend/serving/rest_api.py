...
from ml.compliance.phi_audit_logger import PHIAuditLogger
from ml.models.base_model import BaseModel as MLBaseModel
from ml.models.model_registry import ModelRegistry
from ml.utils.fhir_connector import FHIRConnector
...
if _FASTAPI_AVAILABLE:
    ...
    async def get_metrics():
        from ml.monitoring.clinical_metrics import ClinicalMetrics
